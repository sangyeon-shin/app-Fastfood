...
public class ListViewAdapter extends BaseAdapter {
    ...
    public ArrayList<TabListViewModel> listViewItemList = new ArrayList<TabListViewModel>();

    public ListViewAdapter() {
        super();
    }

    public ListViewAdapter(ArrayList<TabListViewModel> listViewItemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView ==null){
            ...
            convertView = inflater.inflate(R.layout.customzied_listview, parent, false);
        }
        ...
        TabListViewModel listViewItem = listViewItemList.get(position);
    ...
    public void addItem(List<TabListViewModel> list){
        listViewItemList = (ArrayList<TabListViewModel>)list;
    }
}
